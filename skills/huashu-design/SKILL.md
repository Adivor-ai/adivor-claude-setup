...
name: huashu-design
description: >-
  Prototipos de alta fidelidad desechables y piezas animadas, en HTML autocontenido: demos
  interactivos, slides HTML, motion, exploración de direcciones en paralelo. También asesora
  dirección y hace revisión experta. Usar cuando el entregable se enseña, no se mergea: «haz un
  prototipo», «demo para enseñar», «explora variantes», 'hi-fi prototype'. NO usar para código de
  interfaz que va a producción. Instrucciones y referencias en chino.
---
