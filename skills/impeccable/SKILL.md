...
name: impeccable
description: >-
  Proceso de diseño para UI de producto y para interfaces que ya tienen código: app shells,
  dashboards, formularios, settings, onboarding y estados vacíos; también pulir una pantalla
  existente. Lee antes el design system del proyecto. Triggers: «diseña esta pantalla», «arregla
  el dashboard», «mejora esta UI», 'design this screen'. NO usar para landing o portfolio de
  marketing desde cero: eso es design-taste-frontend. NO usar para aplicar un estilo visual:
  encadena después una skill de estilo.
version: 3.5.0
user-invocable: true
...
Las fronteras completas quedan documentadas aquí:

| No uses impeccable para | Usa en su lugar |
|---|---|
| Landing o portfolio de marketing desde cero | `design-taste-frontend` |
| Un componente aislado, sin proyecto detrás | `frontend-designer` |
| Aplicar una estética concreta | `minimalist-ui` · `industrial-brutalist-ui` · `high-end-visual-design` |
| Prototipo desechable o demo animada | `huashu-design` |
| Checklist de UI antes del push | skill `ui-acceptance` |
| Reporte de auditoría visual puntuado | agente `design-auditor` |
| Presentaciones .pptx | `deck-design-system` |
